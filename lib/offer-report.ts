...
import {activationBlock} from './participation';
...
export async function buildOfferReport(api:Api,item:Record<string,unknown>,rawOffers:unknown[],overrides:Record<string,number>,rules:MarginRules):Promise<{cost:ListingCost;offers:OfferReport[]}>{
