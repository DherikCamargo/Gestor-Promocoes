...
5. Envie sua branch e abra um pull request. Dherik revisa antes de incorporar em main. O merge aciona a tarefa automática de build e publicação.
...
Adesão continua bloqueada. Após o merge à main, a automação verifica e publica o código. Se as verificações falharem, a versão anterior permanece. Não enviar mudanças diretamente à main: pushes diretos não acionam o gatilho. Consulte AUTOMACAO-PUBLICACAO.md.
